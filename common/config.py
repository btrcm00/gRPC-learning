...
class Config:
    def __init__(
        ...
        self.data_path = data_path if data_path is not None else os.getenv(DATA_PATH, "service/data")
        ...
        logging_path = logging_path if logging_path is not None else os.getenv(LOGGING_PATH, "service/logs")
